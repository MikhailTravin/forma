 ...
 */
    ...
    (() => {
        ...
        if (document.querySelector(".top-main-about__slider")) new core(".top-main-about__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        document.querySelectorAll(".result-popup__content").forEach((n => {
            const thumbsSwiper = new core(n.querySelector(".result-popup__thumbs"), {
                modules: [ Thumb ],
                observer: true,
                observeParents: true,
                slidesPerView: 6,
            ...
            new core(n.querySelector(".result-popup__slider"), {
                modules: [ Thumb ],
                thumbs: {
                    swiper: thumbsSwiper
                },
        ...
        if (document.querySelector(".doctor-certificates__slider")) new core(".doctor-certificates__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            speed: 800,
        ...
        if (document.querySelector(".doctor-certificates__popup-slider")) new core(".doctor-certificates__popup-slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".result-slider__slider")) new core(".result-slider__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            function initFilters(container) {
                ...
                function resetSelects() {
                    ...
                    if (allOption) {
                        ...
                        if (selectInput) selectInput.value = allOption.querySelector(".select__option-text").textContent;
                    }
                }
                ...
                function applySelectFilter(filterValue) {
                    container.querySelectorAll(itemSelector).forEach((item => {
                        const isMatchBySelect = "all" === filterValue || item.classList.contains(selectFilterClassPrefix + filterValue);
                        item.classList.remove(itemHiddenClass, itemCheckboxHiddenClass);
                        item.classList.toggle(itemCheckboxHiddenClass, !isMatchBySelect);
                    }));
                }
                const selectOptions = container.querySelectorAll(".filter__select .select__option");
                if (selectOptions.length > 0) selectOptions.forEach((option => {
                    option.addEventListener("click", (e => {
                        ...
                        const newUrl = "all" === filterValue ? "/results/" : `?doctor=${filterValue}`;
                ...
                function onCheckboxChange(event) {
                    ...
                    const selectedDoctors = Array.from(container.querySelectorAll(`${checkboxSelector} input[type="checkbox"]:checked`), (checkbox => checkbox.dataset.filter));
                    container.querySelectorAll(itemSelector).forEach((item => {
                        const doctorTypes = (item.dataset.doctor || "").split("-");
                        const isMatchByDoctor = 0 === selectedDoctors.length || selectedDoctors.some((selectedDoctor => doctorTypes.includes(selectedDoctor)));
                        item.classList.remove(itemHiddenClass);
                        item.classList.toggle(itemCheckboxHiddenClass, !isMatchByDoctor);
                    }));
                }
                if (filterReset) filterReset.addEventListener("click", (e => {
                    e.preventDefault();
                    resetAllFilters();
                }));
                setTimeout((() => {
                ...
                container.querySelectorAll(".filter__title").forEach((titleButton => {
                    ...
                    titleButton.addEventListener("click", (e => {
                        ...
                        container.querySelectorAll(itemSelector).forEach((item => {
                            const isMatchByFilter = "all" === filterValue || item.classList.contains(itemFilterClassPrefix + filterValue);
                            item.classList.remove(itemHiddenClass, itemCheckboxHiddenClass);
